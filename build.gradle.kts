...
dependencies {
    implementation(group = "com.fasterxml.jackson.module", name = "jackson-module-kotlin", version = "2.18.0")
    ...
    implementation(platform("io.github.xanthic.cache:cache-bom:0.6.1"))
