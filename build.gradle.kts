...
dependencies {
    implementation(group = "com.fasterxml.jackson.module", name = "jackson-module-kotlin", version = "2.22.1")
    implementation(group = "com.github.twitch4j", name = "twitch4j", version = "1.26.0")
    implementation(group = "ch.qos.logback", name = "logback-classic", version = "1.6.0")
